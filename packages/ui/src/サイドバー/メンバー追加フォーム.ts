...
// 選択中ルームへのメンバー追加フォーム（LV2素部品）。名前+種別セレクト+追加ボタン
  ...
  implements I配線可能<Iメンバー追加フォーム配線>
{
  ...
  constructor() {
    ...
    this._componentRoot = this._ルートを構築する(this._名前入力, this._種別セレクト);
  }
  ...
  private _ルートを構築する(名前入力: TextInputC, 種別セレクト: SelectC): DivC {
    return (
